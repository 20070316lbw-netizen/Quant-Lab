...
class FetchEdgar(DataSource):
    ...
    def _load_cik_map(self) -> pd.DataFrame:
        ...
        # TODO: 最终返回的是 Dataframe 而不是 dict
...
# from pipeline.source.fetch_cik import fetch_origin_json

# HEADERS = {"User-Agent": "liu 20070316lbw@gmail.com"}
# raw = fetch_origin_json(headers = HEADERS)
...
# def fetch_edgar_stock(headers: dict) -> pd.DataFrame:
#     HEADERS = {"User-Agent": "liu 20070316lbw@gmail.com"}
#     URL = f"https://data.sec.gov/api/xbrl/companyconcept/CIK{raw}.json"
#     try:
